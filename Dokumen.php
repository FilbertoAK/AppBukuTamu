...
$query = tampildata("SELECT * FROM dokumen");
?>
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#edit<?=$row['iddokumen']?>">Edit</button>
                                    <button class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#hapus<?=$row['iddokumen']?>">Hapus</button>
                                </td>
                            </tr><!-- Modal -->
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="hapus<?=$row['iddokumen']?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="" method="POST">
                                            <input type="hidden" name="id" value="<?=$row['iddokumen']?>">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="namafile" class="form-label">NamaFile</label>
                                                    <input type="text" class="form-control" name="namafile"
                                                        value="<?=$row['namafile']?>" id="namafile">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="keterangan" class="form-label">Keterangan</label>
                                                    <input type="text" class="form-control" name="keterangan"
